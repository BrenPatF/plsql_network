...
To run the processor, open a powershell window in the npm trapit package folder after placing the output JSON file, tt_utils.purely_wrap_all_nets_out.json, in a new (or existing) folder, oracle_plsql (say), within the trapit subfolder externals and run:
