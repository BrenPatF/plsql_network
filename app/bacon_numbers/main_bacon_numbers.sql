@..\initspool main_bacon_numbers
/***************************************************************************************************
Name: main_bacon_numbers.sql                      Author: Brendan Furey            Date: 13-Feb-2022

Driver script component in the plsql_network module, for the Bacon Numbers example network.
...
Driver script component for the Bacon Numbers example network: Calls r_net.sql.

***************************************************************************************************/
PROMPT links_v based on arcs_bacon_numbers
...
/
COLUMN "Network"        FORMAT A15
COLUMN "Link"           FORMAT A85
