@..\..\initspool main_fk
/***************************************************************************************************
Name: main_fk.sql                                 Author: Brendan Furey            Date: 24-Aug-2019

Driver script component in the plsql_network module, for the foreign key example network.
...
|                   |               |  structure within one detail query and three aggregated      |
...
Driver script component for the foreign key example network: Calls r_net.sql.

***************************************************************************************************/
PROMPT View links_v based on fk_links
